	...
	<script>
		...
		function changeGridIntensity( intensity ) {
			const entryContent = document.querySelector('.entry-content'), 
				figures = document.querySelectorAll('.entry-content .wp-block-image figure:not(.no-carbon), .entry-content figure.wp-block-image:not(.no-carbon), .entry-content figure.wp-block-gallery figure:not(.no-carbon)'),
				gawIntensity = document.querySelector('[data-gaw-mode]');
			let logo;
